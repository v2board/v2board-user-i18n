export default {
  ...
  'nav.knowledge': '使用文档',
  // dashboard
  'dashboard.not_bind_telegram': '绑定 Telegram 获取更多服务',
  ...
  'invite.confirm_commission_tip': '佣金将会在确认后发放到您的佣金账户。',
  ...
  'order.credit_alert': '您的信用卡信息只会被用作当次扣款，系统并不会保存，我们认为这是最安全的。',
  'order.total_amount': '订单总额',
  'order.total': '总计',
  'order.checkout': '结账',
  'order.waiting_payment': '等待支付中',
  'order.result_opening_title': '开通中',
  'order.result_opening_sub_title': '订单系统正在进行处理，请稍等 1-3 分钟。',
  ...
  'plan.choose_another_subscribe': '选择其它订阅',
  // profile
  ...
  'profile.bind_telegram': '绑定 Telegram',
  'profile.start': '立即开始',
  'profile.reset_subscribe': '重置订阅信息',
  'profile.reset': '重置',
  'profile.reset_info_notify_title': '确定要重置订阅信息？',
  'profile.reset_info_notify_content': '如果您的订阅地址或信息泄露可以执行此操作。重置后您的 UUID 及订阅将会变更，需要重新进行订阅。',
  ...
  'subscribe.reset_info_notify_content': '如果您的订阅地址或信息泄露可以执行此操作。重置后您的 UUID 及订阅将会变更，需要重新进行订阅。',
  ...
  'ticket.message': '消息',
  'ticket.please_enter_issue': '请描述您遇到的问题',
  // traffic
  ...
  'bind_telegram_modal.title': '绑定 Telegram',
  'bind_telegram_modal.step_1': '第一步',
  'bind_telegram_modal.step_2': '第二步',
  'bind_telegram_modal.open_telegram_search': '打开 Telegram 搜索',
  'bind_telegram_modal.send_bot_message': '向机器人发送您的',
  // knowledge
  'knowledge': '使用文档',
  ...
  'To do event': '待办事件',
  'There are still unpaid orders': '还有未支付的订单',
  'Pay now': '立即支付',
