export default {
  ...
  'dashboard.subscribe_info': 'Năm {date} đến hạn，Thời gian đến hạn còn {day} ngày. Sau ngày {reset_day} dung lượng sẽ được làm mới.',
  ...
  'subscribe.subscribe_info': 'Năm {date} đến hạn，Thời gian đến hạn còn {day} ngày. Sau ngày {reset_day} dung lượng sẽ được làm mới.',
