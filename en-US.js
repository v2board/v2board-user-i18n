export default {
  ...
  'dashboard.subscribe_info': 'Will expire on {date}, {day} days before expiration',
  ...
  'order.result_success_sub_title': 'The order has been paid and the service has been activated.',
  ...
  'subscribe.subscribe_info': 'Will expire on {date}, {day} days before expiration',
  ...
  'To do event': 'TODO events',
  'There are still unpaid orders': 'There are still unpaid orders',
  'Pay now': 'Pay Now',
  'Ticket is being processed': 'tickets are being processed',
  'View now': 'View Now',
  'Buy subscription': 'Purchase Subscription',
  'Knowledge': 'Knowledge Base',
  'My order': 'My Order',
  'Personal Center': 'User Center',
  'Flow details': 'Transfer Data Details',
  'Configure subscription': 'Configure Subscription',
  'My invitation': 'My Invitation',
  'Node status': 'Access Point Status',
  'There was no incident': 'There are no events',
  'Copied': 'Copied',
  'Product information': 'Product information',
  'Product name': 'Product name',
  'Type/Period': 'Type / Cycle',
  'Product flow': 'Product transfer data',
  'Order information': 'Order information',
  'Close order': 'Close order',
  'Order number': 'Order number',
  'Discount amount': 'Discount amount',
  'Deduction amount': 'Old subscription conversion amount',
  'Refund amount': 'Refund amount',
  'Balance payment': 'Balance Payment',
  'Creation time': 'Creation time',
  'My tickets': 'My Tickets',
  'Tickets history': 'Ticket history',
  'Reset flow after {reset_day} day': 'after {reset_day} days reset transfer data',
  'Node name': 'Access Point Name',
  'Due on {date}, {day} days before expiration': 'Will expire on {date}, {day} days before expiration.'
}
